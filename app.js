...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var multiOutput = multiply(multiply(a,b)[0],c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + sumOutput + '.';
  var multiMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiOutput + '.';
  ...
  return[sumOutput,multiOutput,sumMessage,multiMessage];
}
